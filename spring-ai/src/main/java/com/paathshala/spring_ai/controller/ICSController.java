...
public class ICSController {
    ...
    @GetMapping("/ics-rag")
    public String icsQuestionWithRAG(@RequestParam String q) {
        // Automatic RAG using manual implementation
        return simplifyIC(q);
    }
    ...
    private String findSimilarData(String q) {
        ...
        List<Document> documents =
                vectorStore.similaritySearch(String.valueOf(SearchRequest
                        .builder().query(q).build().getTopK()));
