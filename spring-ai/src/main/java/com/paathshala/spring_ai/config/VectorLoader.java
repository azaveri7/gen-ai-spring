...
public class VectorLoader {
    ...
    @Value("classpath:static/India_Constitution.pdf")
    private Resource pdfResource;

    @Bean
    SimpleVectorStore vectorStore(EmbeddingModel embeddingModel) {
        SimpleVectorStore vectorStore = SimpleVectorStore.builder(embeddingModel).build();
        File vectorStoreFile = new File("/Users/anandzaveri/repos/courses/gen-ai-spring/spring-ai/src/main/resources/vector_store.json");
